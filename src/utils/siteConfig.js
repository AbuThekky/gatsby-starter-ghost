...
module.exports = {
    siteUrl:
        process.env.NODE_ENV === `production`
            ? process.env.SITE_URL || config.siteUrl || `https://venerable-lolly-3061de.netlify.app`
            : `https://venerable-lolly-3061de.netlify.app/`, // Site domain. Do not include a trailing slash!
