...
module.exports = {
    siteUrl:
        process.env.NODE_ENV === `production`
            ? process.env.SITE_URL || config.siteUrl || `https://transcendent-sherbet-33ee48.netlify.app`
            : `https://transcendent-sherbet-33ee48.netlify.app`, // Site domain. Do not include a trailing slash!
